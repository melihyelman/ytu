...
int nextMove(char ***playground, int n, int m, GameData *gameData, char movement) {
    ...
    if (movement == 72) {  // w
        nextX--;
    } else if (movement == 80) {  // s
        nextX++;
    } else if (movement == 75) {  // a
        nextY--;
    } else if (movement == 77) {  // d
        nextY++;
    };
...
GameData *getStartPosition(char ***playground, int n, int m) {
    ...
    gameData->elements = NULL;
    gameData->elementsCapacity = 0;
    gameData->elementsSize = 0;
    gameData->score = 0;
    gameData->time = 0;
    return gameData;
}
...
void playWithManuel(User *user, char ***playground, int n, int m) {
    ...
    do {
        ...
        state = checkMovement(playground, n, m, movement, gameData);
        if (state == -1) {
