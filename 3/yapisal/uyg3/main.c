/* 
SORU:
Verilen 3 boyutlu noktaların orjine olan uzaklıklarını Selection Sort algoritmasıyla büyükten küçüğe
veya küçükten büyüğe sıralayan bir algoritmayı C dilinde gerçekleyelim. 
*/
